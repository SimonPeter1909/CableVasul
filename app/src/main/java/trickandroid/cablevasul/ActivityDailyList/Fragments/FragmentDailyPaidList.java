...
public class FragmentDailyPaidList extends Fragment {
    private static final String TAG = "FragmentDailyPaidList";
    ...
    public static FragmentDailyPaidList newInstance(){
        return new FragmentDailyPaidList();
    }
    ...
    public void setAdapter(View view){
        FirebaseRecyclerOptions<NewConnectionDetails> options = new FirebaseRecyclerOptions.Builder<NewConnectionDetails>()
                .setQuery(nodes.getNodeDailyList().child(getDate().replace("/",",")).child("Connection List").child(getAreaName()).child("paidList"),NewConnectionDetails.class)
                .build();
